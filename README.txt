...
Oracle MySQL EE 5.7 against
[CIS's](https://www.cisecurity.org/cis-benchmarks/) Oracle MySQL EE 5.7
Benchmark 1.0.0 tailored for [CMS ARS
...
It is assumed that the password complexity plugin: validate\_password.so
is installed, otherwise control 7.6 will fail.
...
[issue](https://github.cms.gov/ISPG/cms-ars-3.1-moderate-aws-rds-oracle-mysql-ee-5.7-cis-overlay/issues/new).
